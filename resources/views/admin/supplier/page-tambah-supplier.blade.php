    ...
    <div class="container px-4 mb-4">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.supplier-tambah-aksi') }}" method="POST" class="needs-validation" novalidate>
                    @csrf

                    {{-- nama supplier --}}
                    <div class="form-floating mb-3">
                        <input type="text" name="nama_supplier" id="namaSupplier" value="{{ old('nama_supplier') }}"
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="telp" id="telpSet" value="{{ old('telp') }}"
                    ...
                    {{-- Alamat --}}
                    <div class="form-floating mb-3">
                        <input type="text" name="alamat" id="alamatSet" value="{{ old('alamat') }}"
