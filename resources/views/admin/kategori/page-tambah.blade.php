    ...
    <div class="container px-4 mb-4">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.kategori-aksi') }}" method="POST" class="needs-validation" novalidate>
                    @csrf

                    {{-- Kategori --}}
                    <div class="form-floating mb-3">
                        <input type="text" name="kategori" id="kategoriSet" value="{{ old('kategori') }}"
                    ...
                    {{-- Satuan --}}
                    <div class="form-floating mb-3">
                        <input type="text" name="satuan" id="satuanSet" value="{{ old('satuan') }}"
