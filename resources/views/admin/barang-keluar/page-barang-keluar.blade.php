...
@section('content_admin')
    <div class="container px-4 mb-4">
        ...
        <div class="justify-content-start py-2">
            <a href="{{ url('admin/data-barang-keluar/tambah') }}" class="btn btn-success btn-sm py-2"><span><i
            ...
            <div class="card-body">
                <form method="GET" action="">
                    <div class="row g-2">
                        ...
                        {{-- Reset --}}
                        <div class="col-md-2 d-grid">
                            <a href="{{ route('admin.barang-keluar-data') }}" class="btn btn-secondary">
                                Reset
                            </a>
                        </div>
...
@section('scripts')
    <script>
        function confirmDeleteBKeluar(id) {
            Swal.fire({
                title: 'Apakah Anda yakin?',
                text: 'Data Barang Keluar akan dihapus permanen!',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    document.getElementById('delete-data-barang-keluar-form-' + id).submit();
                }
            });
        }
    </script>
