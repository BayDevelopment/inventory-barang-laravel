...
@section('content_admin')
    <div class="container px-4 mb-4">
        ...
        <div class="justify-content-start py-2">
            <a href="{{ url('admin/pengguna/tambah') }}" class="btn btn-success btn-sm py-2"><span><i
                    ...
                    <tbody>
                        @forelse($d_pengguna as $item)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-sm" href="{{ route('admin.pengguna-edit', $item->id) }}"
                                        role="button" title="Edit"><i class="fa-solid fa-file-pen"></i></a>
                                    <form id="pengguna-delete-form-{{ $item->id }}"
                                        action="{{ route('admin.aksi-pengguna-hapus', $item->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
