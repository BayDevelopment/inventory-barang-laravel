                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="profileTab">
                        <div class="card shadow-sm border-0">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('user.setting-profile') }}">
                                    @csrf
                    ...
                    <div class="tab-pane fade" id="passwordTab">
                        <div class="card shadow-sm border-0">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('user.setting-security') }}">
                                    @csrf
...
@section('scripts')
    <script>
        ...
        // Validasi password dan konfirmasi password sebelum submit
        ...
        form.addEventListener('submit', function(e) {
            // Reset error
            const existingError = document.querySelector('#password-match-error');
            if (existingError) existingError.remove();

            if (password.value !== passwordConfirmation.value) {
                e.preventDefault(); // hentikan submit
                const error = document.createElement('div');
                error.id = 'password-match-error';
                error.className = 'text-danger mb-2';
                error.textContent = 'Password dan konfirmasi password tidak sama.';
                passwordConfirmation.parentNode.insertBefore(error, passwordConfirmation.nextSibling);
